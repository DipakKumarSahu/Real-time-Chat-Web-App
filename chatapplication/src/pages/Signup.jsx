        ...
        <div className="relative backdrop-blur-2xl bg-white/10 border border-white/20 rounded-3xl p-8 md:p-10 shadow-2xl animate-fade-in">
          ...
          <div className="text-center mb-8 md:mb-10">
            ...
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              Create your account to enter the{" "}
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            {/* Password Input */}
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-r from-pink-500/20 to-cyan-500/20 rounded-2xl opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 blur-sm"></div>
              <input
                type="password"
                ...
                required
                disabled={isLoading}
                className="relative w-full px-6 py-4 md:px-8 md:py-5 backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-400/50 focus:border-pink-400/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base"
              />
              <div className="absolute inset-0 rounded-2xl border border-pink-400/30 opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
            </div>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center space-x-4 backdrop-blur-xl bg-white/5 border border-white/10 rounded-full px-6 py-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-purple-400 font-medium">FAST</span>
            </div>
          </div>
        </div>
      </div>
